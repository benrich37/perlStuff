...
def run_dihedral_scan(atoms_obj, ion_dir_path, calc_fn, 
...
def main(debug=False):
    ...
    dihedral_list = oid["dihedral_list"]
    os.chdir(work_dir)
    ...
    mask_list = get_proper_mask_list(oid.get("mask_list", None), len(atoms), log_fn=opt_log)
